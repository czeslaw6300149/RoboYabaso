...
「失去的，永遠不會比你手上現在握住的多。」'];
	  ...
	  let rplyArr = ['\
【碳足跡】:\n碳足跡或譯碳足印。指每個人、家庭或每家公司日常釋放的溫室氣體數量（以二氧化碳即CO2的影響為單位），用以衡量人類活動對環境的影響。單位通常為噸/ppm','\
【蘭徹斯特方程】:\n全稱為蘭徹斯特戰鬥動態方程，也常稱為蘭徹斯特作戰模型。是二戰後形成的軍事運籌學、數理戰術學的重要作戰模擬理論。二戰初期，採用「蘭徹斯特方程」式作戰的同盟軍，被採用「閃電戰」理論的德軍奪走戰爭的主動權。最著名的應用就是硫磺島戰役。當今美國陸軍使用的數字化模擬系統，仍以蘭徹斯特方程為主要理論對戰鬥力進行量化和計算。\n《應用》:另A(S)為A國戰鬥人數、B(S)為B國戰鬥人數、且各單位戰鬥力一樣。\n狀態一.狹路相逢：那就是蘭徹斯特線性法則，將雙方兵力對減A(S)-B(S)。\n狀態二.開闊空間：那就是蘭徹斯特曲線法則，將雙方兵力平方後對減再開根號(√[A(S)2-B(S)2])\n第二法則:近代集體戰鬥可以視為(武器性能)*(敵人數)^2。。','\
【日內瓦公約】:\n包括1949年8月12日在日內瓦(瑞士第二大城市)重新締結的四部基本的國際人道法，為國際法中的人道主義定下了標準。它們主要有關戰爭受難者、戰俘和戰時平民的待遇。它們並不影響在1899年和1907年的《海牙公約》覆蓋的武器的使用及1925年在《日內瓦協議》中在對氣體和生物武器的使用。\n現在，《日內瓦公約及其附加議定書》指《1949年8月12日日內瓦四公約》及後來產生的它們的共同附加議定書','\
【上午茶】:\nelevenses或forenoon tea，是早上工作了一會後喝茶、吃小食的時間，於11時左右進食。上午茶和早午餐的分別在於前者是非正式的，而進食早午餐的人在之前尚未進食早餐。(出自:桌遊 午前茶點)','\
【世界語】:\n又稱『希望語』，因為Esperanto在該語言中的意思即『希望』，舊譯萬國新語、愛斯不難讀，是最為廣泛使用的人工語言。','\
【電磁裝甲】:\n21世紀後出現的主力戰車領域防禦概念，目前處於研發階段，尚未有實際應用，可分為被動式電磁裝甲與主動式電磁裝甲兩種概念，主要是透過電磁力增加裝甲的防護力削減敵方砲彈造成的殺傷。','\
【理髮師走馬燈】:\n以「藍白紅」三色為主的走馬燈。二戰期間，法國一名愛國理髮師引導德軍去錯誤的方向，使得法軍能夠順利脫逃，但他最後不幸被德軍殺死，自此法國人就用國旗顏色「藍紅白」的走馬燈，掛在他的店門口表示最高致意和紀念。','\
【來一場昆特牌吧】:\n巫師3的梗。遊戲中有個小遊戲叫做昆特牌，設定上面任何時候都可以跟NPC玩昆特牌，因此導致在某些狀況下會變得很搞笑。例如城堡失火人家在問你怎麼辦你回「不來場昆特牌嗎?」這樣，而且NPC性情馬上會180度大轉變說「村里沒人贏的了我!」。','\
【喬戈里峰】:\n為塔吉克語「高大雄偉」之意，而K2是國際上最常見的名稱。為巴基斯坦的最高峰（印度方面則認為K2峰為其最高峰），也是中國和世界的第二高峰，海拔8611公尺，僅次於聖母峰。1856年西方探險隊首次考察此地區時，標出了喀喇崑崙山脈自西向東的5座主要山峰(k1-k5)，而喬戈里峰就是K2。登山活動的最佳時機應安排在5月至6月初進山，其時河水雖漲，但不太嚴重；7月至9月，山頂氣溫稍高，好天氣持續時間較長，是登頂的好時間。死亡率約為20%。\n <補充小知識> \n K1-瑪夏布洛姆峰\n K2-喬戈里峰\n K3-布洛阿特峰(K2擴充) Broad peak\n K4-加舒爾布魯木II峰\n K5-加舒爾布魯木I峰\n 喀喇崑崙山脈:突厥語意為「黑色岩山」','\
【馬約卡島】:\n西班牙語：Mallorca，是西班牙的巴利亞利群島的最大島嶼，位於西地中海，是著名的旅遊點和觀鳥去處。中世紀以瓷器著名（義大利花飾瓷器），多古羅馬、腓尼基和迦太基遺址。貫通全島北部的Tramuntana山脈地區由於獨特的地形地貌被聯合國教科文組織於2011年評選為世界自然遺產。','\
【卡爾卡松】:\n法語：Carcassonne，是法國朗格多克-魯西永大區奧德省的一個鎮。卡爾卡松分為新舊兩個城區，分別坐落於奧德河東西兩側。西部的新城區地勢較低且佔地較廣，而東部的老城區則有城牆圍繞。卡爾卡松的防禦工事最早可回溯到羅馬時代。1659年，庇里牛斯條約將邊境的魯西永大省割讓給法國，卡爾卡松在戰略上的重要性才逐漸消失，羊毛紡織業成為主要的經濟活動。早在羅馬時期，老城區於1853年由建築師Eugène Viollet-le-Duc開始修復，並於1997年納入聯合國教科文組織的世界文化遺產。今日的卡爾卡松最主要的經濟來源為觀光業，除了老城區，米迪運河也吸引許多觀光客。在觀光業之外，卡爾卡松的經濟活動還包括釀酒、紡織、製鞋等行業。','\
【列支敦斯登公國】:\n歐洲中部的內陸小國（聯合國區域集團定義為西歐國家），夾在瑞士與奧地利兩國間，為世界上僅有的兩個雙重內陸國之一（另一個為烏茲別克）。同時該國也是唯一一個官方語言是德語但與德國沒有交界的國家。這個君主立憲制的山區小國，雖然土地狹小兼人口稀少，但卻擁有異常高的國民所得水準，其人均國內生產總值高達60,000歐元，是一個以阿爾卑斯山美麗風光、避稅天堂與高生活水準而著稱的富裕小國。','\
【全能悖論】:\nomnipotence paradox，該悖論的內容是：如果任一個體是「全能」的話，那麼他就一定能夠制訂出一個他不能履行的工作，如此他就不會是全能的；反之，若一個「全能」的個體不能夠制訂出一個他不能履行的工作，如此他也不會是全能的。因此，無論他能否制訂這項工作，他也不會是全能的。但偶發全能可以避開此悖論。但是偶發全能是否能算全能就又是另一則辯思了。','\
【墨菲定律】:\nMurphy’s law，科學方面具體內容是「凡是可能出錯的事必定會出錯」，指的是任何一個事件，只要具有大於零的機率，就不能夠假設它不會發生。在文化方面，它代表一種近似反諷的幽默，當作對日常生活中不滿的排解。','\
【傑羅尼莫】:\nGeronimo，是印第安人中的一名傳奇戰士及阿帕契族的酋長，出生於亞利桑那州的希拉河，曾帶領原住民反抗美國及墨西哥，被印地安人視為民族英雄，後來於1886年歸順美國。後來引伸為一種精神喊話(類似德瑪西亞)。','\
...
【約翰。彌爾】:\n捍衛言論自由的英國人。認為言論自由主要目的是為了更正確的得到知識。大家有講話的自由正確的說法就會被傳播，錯誤的說法會有更高機會被修正，最後大家都會得到正確的知識，就跟wiki一樣。','\
【反應裝甲】:\n是一種主要通過爆炸來破壞射中炮彈以降低其攻擊力的裝備。','\
【波多黎各】:\npuerto rico，是美國在加勒比海地區的一個自由邦（境外領土），首府為聖胡安。在西班牙語裡波多黎各的意思是「富裕之港」。波多黎各是大安的列斯群島四個大島中最小的一個島。','\
【羅蕾萊】:\n德文:Loreley或Lorelei，是一座萊茵河中游東岸高132米的礁石，坐落在德國萊茵蘭-普法爾茨州境內。羅蕾萊礁石處的萊茵河深25米，卻只有113米寬，是萊茵河最深和最窄的河段，險峻的山岩和湍急的河流曾使得很多船隻在這裡發生事故遇難，如今仍有信號燈指引過往船隻注意安全。傳說在羅蕾萊山頂上有位美若天仙的女妖羅蕾萊，用動人的美妙歌聲誘惑著行經的船隻使之遇難。與賽蓮是不同傳說','\
【馬格努斯效應】:\n是一個流體力學當中的現像，是一個在流體中轉動的物體(例如圓柱體)受到的力。應用非常多，尤其在球類運動方面。','\
【創傷後心理壓力緊張症候群】:\npost-traumatic stress disorder；PTSD。又譯重大打擊後遺症..等。指人在遭遇或對抗重大壓力後，其心理狀態產生失調之後遺症。這些經驗包括生命遭到威脅、嚴重物理性傷害、身體或心靈上的脅迫。有時候被稱之為創傷後壓力反應（post-traumatic stress reaction）以強調這個現象乃經驗創傷後所產生之合理結果，而非病患心理狀態原本就有問題。','\
【諸神的黃昏】:\nRagnarök，是北歐神話預言中的一連串巨大劫難，包括造成許多重要神祇死亡的大戰（奧丁、索爾、弗雷、海姆達爾、火巨人、霜巨人、洛基等），無數的自然浩劫，之後整個世界沉沒在水底。然而最終世界復甦了，存活的神與兩名人類重新建立了新世界。這是北歐神話極重要的一部份，也是許多學術研討與理論的主題。'];
	   return rplyHead[Math.floor((Math.random() * (rplyHead.length)) + 0)] + '\n' + rplyArr[Math.floor((Math.random() * (rplyArr.length)) + 0)];
        }
////////////////////////////////////////
//////////////// Funny
