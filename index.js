...
【上午茶】:\n\
	elevenses或forenoon tea，是早上工作了一會後喝茶、吃小食的時間，於11時左右進食。\
...
【喬戈里峰】:\n\
	...
	<補充小知識> \n\
        ...
        喀喇崑崙山脈:突厥語意為「黑色岩山」','\
【馬約卡島】:\n\
	西班牙語：Mallorca，是西班牙的巴利亞利群島的最大島嶼，位於西地中海，是著名的旅遊點和觀鳥去處。\
	世紀以瓷器著名（義大利花飾瓷器），多古羅馬、腓尼基和迦太基遺址。\
	貫通全島北部的Tramuntana山脈地區由於獨特的地形地貌被聯合國教科文組織於2011年評選為世界自然遺產。','\
【卡爾卡松】:\n\
	法語：Carcassonne，是法國朗格多克-魯西永大區奧德省的一個鎮。卡爾卡松分為新舊兩個城區，分別坐落於奧德河東西兩側。\
...
【全能悖論】:\n\
	omnipotence paradox，該悖論的內容是：如果任一個體是「全能」的話，那麼他就一定能夠制訂出一個他不能履行的工作，如此他就不會是全能的；\
	反之，若一個「全能」的個體不能夠制訂出一個他不能履行的工作，如此他也不會是全能的。\
	因此，無論他能否制訂這項工作，他也不會是全能的。但偶發全能可以避開此悖論。但是偶發全能是否能算全能就又是另一則辯思了。','\
【墨菲定律】:\n\
	Murphy’s law，科學方面具體內容是「凡是可能出錯的事必定會出錯」，指的是任何一個事件，只要具有大於零的機率，就不能夠假設它不會發生。\
	在文化方面，它代表一種近似反諷的幽默，當作對日常生活中不滿的排解。','\
【傑羅尼莫】:\n\
	Geronimo，是印第安人中的一名傳奇戰士及阿帕契族的酋長，出生於亞利桑那州的希拉河，曾帶領原住民反抗美國及墨西哥，被印地安人視為民族英雄，\
...
【波多黎各】:\n\
	puerto rico，是美國在加勒比海地區的一個自由邦（境外領土），首府為聖胡安。\
	在西班牙語裡波多黎各的意思是「富裕之港」。波多黎各是大安的列斯群島四個大島中最小的一個島。','\
【羅蕾萊】:\n\
	德文:Loreley或Lorelei，是一座萊茵河中游東岸高132米的礁石，坐落在德國萊茵蘭-普法爾茨州境內。\
...
【創傷後心理壓力緊張症候群】:\n\
	post-traumatic stress disorder；PTSD。又譯重大打擊後遺症..等。指人在遭遇或對抗重大壓力後，\
	其心理狀態產生失調之後遺症。這些經驗包括生命遭到威脅、嚴重物理性傷害、身體或心靈上的脅迫。\
	有時候被稱之為創傷後壓力反應（post-traumatic stress reaction）以強調這個現象乃經驗創傷後所產生之合理結果，\
	而非病患心理狀態原本就有問題。','\
【諸神的黃昏】:\n\
	Ragnarök，是北歐神話預言中的一連串巨大劫難，包括造成許多重要神祇死亡的大戰（奧丁、索爾、弗雷、海姆達爾、火巨人、霜巨人、洛基等），\
...
【花衣魔笛手】:\n\
	德文Rattenfänger，又稱「哈梅爾的吹笛人」，德國的民間故事。研究者相信故事源於一件真實的歷史事件，但究竟是那一件，則眾說紛紜。\
	一說那些孩子代表了當時到東歐殖民的年輕人；一說那些孩童代表了1212年的兒童十字軍。','\
【熱寂】:\n\
	Heat Death，是猜想宇宙終極命運的一種假說。根據熱力學第二定律，作為一個「孤立」的系統，宇宙的熵會隨著時間的流易而增加，\
...
【德雷珀點】:\n\
	Draper point，大約800K(798K、525度)，在此溫度下，幾乎所有物體都會開始放出暗紅色光。','\
【巨球會】:\n\
	BIG GLOBE，一個架空組織，目的在騙世人地球是圓的。\n\
	1.重力問題:地球其實是整體向上以9.81m/s^2在移動故會感到重力。\n\
	2.日蝕、星象、太陽問題:指要重新定義各自的距離以即移動方式就可以了。\n\
	3.宇宙觀察:可造假，而且也可以說是"太慢"導致(儀器接近光速下地球的確會是平的)。','\
【達克效應】:\n\
	D-K effect全稱為鄧寧-克魯格效應（英語：Dunning–Kruger effect），是一種認知偏差現象，未經訓練的個體會感到一種虛幻的自我優越感，\
	錯誤地認為自己比大多數人都優秀。','\
【海軍咖哩】:\n\
...
【驢橋】:\n\
	Eselsbrücke，德文的「der Esel」是「驢子」的意思；而，德語的「die Brücke」是「橋樑」的意思。\
...
【拉布列康】:\n\
	矮精靈或矮妖（Leprechaun，音譯拉布列康），共通特徵就是紅色鬍子和整齊的綠衣綠帽。矮精靈非常喜歡收集黃金，\
	並把黃金埋藏在彩虹的盡頭。通常認為酢漿草和穿綠色衣物可以吸引矮精靈。如果被人抓到，矮妖會用自己的魔法實現人的三個願望來換取自由。','\
【逆火效應】:\n\
...
【老鞋】:\n\
	法語，原文為「Savate」。法國踢腿術。法國踢腿術是唯一一種准許鬥士穿鞋的踢擊武術。','\
【卡利】:Kali，一種菲律賓的武術，主要是用棍。','\
【卡波耶拉】:\n\
	Capoeira，或稱卡波衛勒，香港亦有譯作巴西戰舞，是一種16世紀時由巴西的非裔移民所發展出，介於藝術與武術之間的獨特舞蹈。\
